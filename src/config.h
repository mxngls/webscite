...
#ifndef _SITE_EXT_EXCEMPT_EXTRA
#define _SITE_EXT_EXCEMPT_EXTRA
#endif

#define _SITE_EXCEMPT_LIST _SITE_EXT_SITE_INDEX, _SITE_EXT_BLOG_INDEX, _SITE_EXT_EXCEMPT_EXTRA
